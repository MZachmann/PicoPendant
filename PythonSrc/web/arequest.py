# from https://github.com/DrTom/py-u-async-http-client core.py
try:
...
async def open_conn(req):
    ...
    # v = await asyncio.open_connection(url_params['host'], url_params['port'], ssl=ssl)
    v = await asyncio.open_connection(url_params['host'], url_params['port'])
    return v
